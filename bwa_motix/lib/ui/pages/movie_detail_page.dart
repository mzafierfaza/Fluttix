...
class MovieDetailPage extends StatelessWidget {
  // biasakan inisialisasi yang kita butuh
  // misal kita perlu class movie, maka buatlah object dari movie tsb
  // seperti dibawah ini.
  //
  final Movie movie;
  ...
  Widget build(BuildContext context) {
    ...
    List<Credit> credits;
    // ^ variabel untuk menyimpan data yang diperlukan
          ...
          ListView(
            children: <Widget>[
              FutureBuilder(
                  ...
                  builder: (_, snapshot) {
                    if (snapshot.hasData) {
                      // ^ jika snapshot ada datanya, maka lakukan ini
