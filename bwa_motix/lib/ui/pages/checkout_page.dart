...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    int total = (35000 * widget.ticket.seats.length) +
        (1500 * widget.ticket.seats.length);
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      BlocBuilder<UserBloc, UserState>(
                        // ^ bloc builder (userbloc) untuk mengambil saldo user,
                        // pokokny kalo nak minta apopun tentang user harus ado user bloc
                        builder: (_, userState) {
